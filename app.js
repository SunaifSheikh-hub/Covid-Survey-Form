$(document).ready(function() {
    ...
    function addQuestion() {
      ...
      newQTypeArr[0] = labelEl.clone().append(newQTypeRadioEl, " You meet by corona patient?");
      ...
      newQTypeArr[1] = labelEl.clone().append(newQTypeCheckEl, "You Have Flu?");
      ...
      newQTypeArr[2] = labelEl.clone().append(newQTypeTextEl, "You Have Cough?");
